...
export class LoginComponent implements OnInit {
    ...
    quote: Quote = {
        ...
        'en': 'I suddenly feel myself like a doll,acting all kinds of joys and sorrows.There are lots of shining silvery'
        + ' thread on my back,controlling all my action.',
